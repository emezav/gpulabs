...
Este proyecto explora la implementación de algunas operaciones básicas sobre matrices 2D con un mapeo hilo-dato adecuado de acuerdo con la naturaleza del problema.
...
A partir de la funcionalidad base que muestra el proceso de escalado en 1D y suma en 2D, desarrollar las siguientes tareas:

1. Implementar la funcionalidad para escalado de matrices
2. Implementar la funcionalidad para la operación GEMV por filas (matriz x vector).
3. Implementar la funcionalidad para la operación GEMM (matriz x matriz).
